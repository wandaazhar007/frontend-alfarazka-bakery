...
import FaqSchema, { type FaqItem } from "../faqSchema/FaqSchema";
import {
...
const FaqMini: React.FC = () => {
  ...
  useEffect(() => {
    const loadSiteSettings = async () => {
      try {
        ...
        console.error("Gagal memuat site settings di FaqMini:", error);
      }
    };
  ...
  const whatsappLink = useMemo(() => {
    return buildWhatsAppUrl(
      whatsappNumber,
      `Assalamualaikum, saya ingin tanya lebih lanjut soal pemesanan roti ${businessName}.`
    );
        ...
        <div className={styles.inner}>
          ...
          <div className={styles.leftBox}>
            ...
            <p className={styles.subtitle}>
              ...
              sini, kamu bebas tanya langsung lewat WhatsApp {businessName}.
            </p>
            ...
            <Link href={whatsappLink} className={styles.ctaButton}>
