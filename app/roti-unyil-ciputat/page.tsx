        ...
        <div className="container">
          <div className={styles.heroInner}>
            ...
            <div className={styles.heroContent}>
              <p className={styles.heroKicker}>Roti Unyil Seribuan di Ciputat</p>
              <h1 id="roti-unyil-hero-heading" className={styles.heroTitle}>
        ...
        <div className="container">
          ...
          <div className={styles.featuresGrid}>
            <article className={styles.featureCard}>
              ...
              <p>
                Mulai dari Rp1.000 per pcs, kamu bisa isi snack box tanpa bikin
                kantong jebol. Cocok untuk acara skala kecil sampai besar.
              </p>
            </article>
            ...
            <article className={styles.featureCard}>
              ...
              <p>
                Pilihan varian rasa manis, gurih, dan keju yang disukai anak-anak
                sampai orang tua. Enak jadi teman teh atau kopi.
              </p>
            </article>
        ...
        <div className="container">
          ...
          <div className={styles.variantsGrid}>
            ...
            <article className={styles.variantCard}>
              ...
              <p>
                Kombinasi manis dan gurih dalam satu paket. Praktis untuk snack
                box pengajian dan arisan ibu-ibu.
              </p>
          ...
          <div className={styles.testimoniScroller}>
            <div className={styles.testimoniTrack}>
              <article className={styles.testimoniCard}>
                <FontAwesomeIcon icon={faStar} className={styles.testimoniIcon} />
                <p>
              ...
              <article className={styles.testimoniCard}>
                <FontAwesomeIcon icon={faStar} className={styles.testimoniIcon} />
                <p>
                  &quot;Cocok untuk rapat kantor, rasanya enak dan tidak terlalu
                  manis. Harga juga masih masuk budget kantor.&quot;
                </p>
                <span className={styles.testimoniMeta}>
              ...
              <dl className={styles.faqList}>
                <div className={styles.faqItem}>
                  <dt>
                    ...
                    />
                    <span>
                      Minimal order roti unyil berapa pcs untuk area Ciputat?
                    </span>
                  </dt>
                  <dd>
                    Untuk pesanan biasa, minimal sekitar 25–30 pcs. Untuk acara
                    seperti pengajian atau arisan, biasanya pelanggan pesan
                    mulai 50 pcs ke atas agar cukup untuk semua tamu.
                  </dd>
                </div>
                ...
                <div className={styles.faqItem}>
                  <dt>
                    <FontAwesomeIcon
                      ...
                      className={styles.faqIcon}
                    />
                    <span>Apakah bisa campur varian manis dan gurih?</span>
                  </dt>
                  <dd>
                    Bisa. Justru kami sarankan mix beberapa varian manis dan
                    gurih supaya tamu punya pilihan. Kamu tinggal infokan
                ...
                <div className={styles.faqItem}>
                  <dt>
                    <FontAwesomeIcon
                      ...
                      className={styles.faqIcon}
                    />
                    <span>Pengiriman roti unyil bisa ke mana saja?</span>
                  </dt>
                  <dd>
                    Fokus utama kami area Ciputat dan sekitarnya: UIN,
                    Gintung, Pamulang, BSD tertentu, dan beberapa titik lain di
                    Tangerang Selatan. Ongkir dan titik temu bisa dibicarakan
                    via WhatsApp.
                  </dd>
                </div>
                ...
                <div className={styles.faqItem}>
                  <dt>
                    <FontAwesomeIcon
                      ...
                      className={styles.faqIcon}
                    />
                    <span>Pembayaran bisa pakai apa saja?</span>
                  </dt>
                  <dd>
                    Bisa transfer bank atau e-wallet tertentu yang tersedia.
                    Untuk pesanan jumlah besar, biasanya kami minta DP sebagai
                    tanda jadi, lalu pelunasan saat atau sebelum pengantaran.
                  </dd>
                </div>
              </dl>
            </div>
